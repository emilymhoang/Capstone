<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Property Info.aspx.cs" Inherits="_Default" %>
...
<div  class="container">
   ...
   <header style="margin-top: 8rem;">
	...
	<asp:ListItem Value="WY">Wyoming</asp:ListItem>
          ...
          <div class="row">
            <div class="col">
              <label for="formGroupExampleInput">Don't fret, only your city, state, and zip code will appear on your profile to potential housemates</label>
            </div> <!--end col-->
          </div> <!--end row class-->
             <div class="row">
            <div class="col">
