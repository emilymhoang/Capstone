<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GetStarted.aspx.cs" Inherits="GetStarted" %>
  ...
  <section id="creation" style="margin-top: 4rem;">
   ...
   <header style="margin-top: 8rem;">
      <div class="container">
        ...
        <p>Tell us some things about yourself so we can find the best option for you.</p>
           <div class="progress " >
        ...
        <div class="col-md-6"></div>
             <div class="col-md-6">
                <asp:Button ID="RentMyRoomButton" class="btn" style="float: right;" runat="server" Text="Rent My Room" onClick = "RentMyRoom" AutoPostBack ="true"></asp:Button>
                <asp:Button ID="FindMyRoomButton" class="btn" style="float: right;" runat="server" Text="Find My Room" OnClick ="FindMyRoom" AutoPostBack ="true"></asp:Button>
             </div>  
    </header>
     </form> <!--end form-->
      </div> <!--end container-->
        ...
        <form runat="server">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <asp:Textbox type="text" ID="confirmPasswordTextbox" class="form-control" MaxLength="30" placeholder="Confirm Password" runat="server"></asp:Textbox>
                 ...
                 </br><asp:Label ID="resultmessage" runat="server" ForeColor="Red"></asp:Label>
            </div>
              <div class="col">
              <label for="formGroupExampleInput"></label>
            </div>
